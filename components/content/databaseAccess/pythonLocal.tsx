    ...
    <Styled>
      ...
      <div className="content">
        ...
        <div>
          <h1>Python Local</h1>
          <br />
          <h3><Link href="https://github.com/sciserver/giverny/raw/master/DEMO_local_python_notebooks.zip" target="_blank">Download</Link> a Python notebook Getdata_JHTDB_2.ipynb</h3>
          <p>
