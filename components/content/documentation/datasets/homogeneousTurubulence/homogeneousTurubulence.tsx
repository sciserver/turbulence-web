  ...
  const datasetsList: CardLayout[] = [
    {
      ...
      onClick: () => {
        router.push('/datasets/homogeneousTurbulence/isotropic'); 
      },
    ...
    },
    {
      ...
      onClick: () => {
        router.push('/datasets/homogeneousTurbulence/mhd'); 
      },
    ...
    },
    {
      ...
      onClick: () => {
        router.push('/datasets/homogeneousTurbulence/hbdt'); 
      },
    ...
    },
    {
      ...
      onClick: () => {
        router.push('/datasets/homogeneousTurbulence/isotropic4096'); 
      },
    ...
    },
    {
      ...
      onClick: () => {
        router.push('/datasets/homogeneousTurbulence/isotropic8192'); 
      },
